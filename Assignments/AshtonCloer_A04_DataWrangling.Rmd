...
```{r setup, message = FALSE, glimpsing each data set}
...
intersection_03.df <- intersect(EPAair_03_NC2018.select.df$Site.Name, EPAair_03_NC2019.select.df$Site.Name)

intersection_pm.df <- intersect(EPAair_PM25_NC2018.select.df$Site.Name, EPAair_PM25_NC2019.select.df$Site.Name)

Intersection_all <- intersect(intersection_03.df, intersection_pm.df)

class(EPAair_2018thru2019.df$Site.Name)

EPAair_2018thru2019.df$Site.Name <- as.character(EPAair_2018thru2019.df$Site.Name)
