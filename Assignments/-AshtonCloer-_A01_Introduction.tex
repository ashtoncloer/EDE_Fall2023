...
\begin{quote}
Answer: Last year, I was in Betsy's Statistical Analysis class where I
was introduced to R. Prior, I completed AP Stats in high school. But I
do not have experience with Git.
\end{quote}
...
\begin{quote}
Answer: I feel confident when it comes to working with and manipulating
data, as well as communicating it.
\end{quote}
...
\begin{quote}
Answer: I feel apprehensive about the technology and software in the
class. Other than Betsy's class last year, I do not have much experience
with R or Git. While trying to download all of the software, I kept
getting confused. I was not even aware of my own MacOS terminal or what
is is/could be used for.
\end{quote}
...
\begin{quote}
Answer: \url{https://github.com/ashtoncloer/EDE_Fall2023/tree/main}
\end{quote}
